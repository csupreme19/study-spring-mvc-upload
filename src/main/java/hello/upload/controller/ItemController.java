...
public class ItemController {
    ...
    public String saveItem(@ModelAttribute ItemForm form, RedirectAttributes redirectAttributes) throws IOException {
        UploadFile attachment = fileStore.storeFile(form.getAttachment());
    ...
    public ResponseEntity<Resource> downloadAttachment(@PathVariable Long itemId) throws MalformedURLException {
        ...
        String storeFileName = item.getAttachment().getStoreFileName();
        String uploadFileName = item.getAttachment().getUploadFileName();
